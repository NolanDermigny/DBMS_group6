...
/**
 * This class is responsible for creating all the tables needed for the
 * database.
 */
public class MakeTables {
	...
	/**
	 * Creates the LOCATION table and drops related tables if they exist.
	 */
	...
	/**
	 * Creates the GAME_CHARACTER table.
	 */
	...
	/**
	 * Creates the GENERIC_ITEM table.
	 */
	 ...
	 */
	public static void createContainerTable(Statement stmt) throws SQLException {
	 ...
	 */
	public static void createArmorTable(Statement stmt) throws SQLException {
		stmt.executeUpdate("DROP TABLE IF EXISTS ARMOR");
		String createArmor = """
				  CREATE TABLE ARMOR (
	...
	/**
     * Creates the ABILITY table.
     */
	public static void createAbility(Statement stmt) throws SQLException {
